    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
            ...
            {/* Product info */}
            <div className="lg:col-span-1 max-t-auto max-w-2xl px-4 pb-16 sm:px-16 lg:max-w-7xl lg:px-8 lg:pb-24">
                ...
                <Grid container spacing={7}>
                    <Grid item xs={7}>
                        <div className='space-y-5'>
                            {[1,1,1,1].map((items) => <ProductReviewCard />)}
                        </div>
                    </Grid>

                    <Grid item spacing={5}>
                        <h1 className='text-xl fonr-semibold pb-1'>Products Rating</h1>
                        <div className='flex items-center space-x-3'>
                        ...
                        <Box className='mt-5 space-y-1'>
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, marginLeft: '24px'}} 
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, marginLeft: '24px'}} 
                                        variant='determinate' value={52} color="success" />
                                </Grid>
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, marginLeft: '24px'}} 
                                        variant='determinate' value={35} color="info" />
                                </Grid>
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, marginLeft: '24px'}} 
                                        variant='determinate' value={23} color="warning" />
                                </Grid>
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, marginLeft: '24px'}} 
                                        variant='determinate' value={12} color="error" />
                                </Grid>
